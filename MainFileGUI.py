...
class MainWindow(QWidget):
    ...
    def init_mainWindow(self):
        ...
        self.label_RegionOfInterest = QLabel('Would you like select one or several Region(s) Of Interest (ROI) ?')
...
#        #Choose the machine learning model 
        ...
        self.comboBox_model.addItem('Support Vector Machine (OpenCV)')
        self.comboBox_model.addItem('K-Nearest Neighbors (OpenCV)')
        ...
        self.CheckBox_infoFile=QCheckBox('Information file (surface, aspect ratio... )')
        ...
        grid.addWidget(self.button_execute,16,2)
